...
<script type="text/javascript">
	function registerCheckFunction() {
		var userID = $('#userID').val();//하나의 유저아이디값을 가지는 요소의 값을 가져오겠다
		$.ajax({ //비동기 방식
			type: 'POST',
			url: './UserRegisterCheckServlet', 
			data: {userID: userID}, //속성과 속성값을 가져옴
...
<body>
	<%
		...
		if (userID != null) {
			...
			session.setAttribute("messageContent", "현재로그인 되어 있는 상태입니다.");
			...
			<table class="table table-bordered table-hover" style="text-align: center; border:1px solid #dddddd">
				...
				<tbody>
					...
					<tr>
						...
						<td colspan="2"><input onkeyup="passwordCheckFunction();" class="form-control" type="password" id="userPassword2" name="userPassword2" maxlength="20" placeholder="비밀번호확인를 입력하세요."></td>
					</tr>
					<tr>
						<td style="width:110px"><h5>이름</h5></td>
						<td colspan="2"><input class="form-control" type="text" id="userName" name="userName" maxlength="8" placeholder="이름을 입력하세요."></td>
					</tr>
					<tr>
						<td style="width:110px"><h5>나이</h5></td>
						<td colspan="2"><input class="form-control" type="number" id="userAge" name="userAge" maxlength="8" placeholder="나이를 입력하세요."></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td colspan="2"><input class="form-control" type="email" id="userEmail" name="userEmail" maxlength="30" placeholder="이메일을 입력하세요."></td>
					</tr>
					<tr>
