			...
			<table class="table table-bordered table-hover" style="text-align: center; border:1px solid #dddddd">
				...
				<tbody>
					...
					<tr>
						...
						<td colspan="2"><input class="form-control" type="text" id="userName" name="userName" maxlength="8" placeholder="이름을 입력하세요." value="<%= user.getUserName()%>"></td>
					</tr>
					<tr>
						<td style="width:110px"><h5>나이</h5></td>
						<td colspan="2"><input class="form-control" type="number" id="userAge" name="userAge" maxlength="8" placeholder="나이를 입력하세요." value="<%= user.getUserAge()%>"></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td colspan="2"><input class="form-control" type="email" id="userEmail" name="userEmail" maxlength="30" placeholder="이메일을 입력하세요." value="<%= user.getUserEmail()%>"></td>
					</tr>
					<tr>
